          ...
          <div class="col-lg-12">
            <div class="form-panel">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                  <label class="sr-only" for="exampleInputtext2">Login address</label>
                  <input type="text" class="form-control" id="login" name="login" placeholder="Enter pseudo">
                </div>
                <div class="form-group">
                ...
                <button type="submit" name="btsave" class="btn btn-theme">Save</button>
              </form>
            </div>
            <!-- /form-panel -->
          </div>
...
$fname=$_POST['fname'];
$lname=$_POST['lname'];
if(($login!="")&&($mp!="")&&($role!="")&&($fname!="")&&($lname!=""))
{
	
$result=$db->query("INSERT INTO utilisateur(login, motpass, fname, lname, role) VALUES ('$login','$mp','$fname','$lname','$role')");//  modifier le nom de table aussi les att
